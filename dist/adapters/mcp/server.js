...
export function registerMemoryModuleTools(server, ports) {
    ...
    }, wrapToolHandler((args) => contextualApp.getRecentContext(contextual, args.agent_key, args.limit)));
    ...
    }, wrapToolHandler((args) => contextualApp.appendContextualMemory(contextual, args.agent_key, args.new_entry)));
    ...
    }, wrapToolHandler((args) => contextualApp.getAllContext(contextual, args.agent_key)));
    ...
    }, wrapToolHandler((args) => semanticApp.appendSemanticMemory(semantic, semConfig, args.agent_key, args.embedding, args.content, args.metadata)));
    ...
    }, wrapToolHandler((args) => semanticApp.searchSemanticMemory(semantic, semConfig, args.agent_key, args.embedding, args.top_k, args.score_threshold)));
    ...
    }, wrapToolHandler((args) => contextualApp.getMemoryStats(contextual, args.agent_key)));
    ...
    }, wrapToolHandler((args) => contextualApp.rollupMemorySegment(contextual, args.agent_key, args.keep_last, args.summary_entry)));
    ...
    }, wrapToolHandler((args) => scratchpadApp.setScratchpadEntry(scratchpad, args.agent_key, args.name, args.value, args.ttl_seconds)));
    ...
    }, wrapToolHandler((args) => scratchpadApp.getScratchpadEntry(scratchpad, args.agent_key, args.name)));
    ...
    }, wrapToolHandler((args) => scratchpadApp.clearScratchpadEntry(scratchpad, args.agent_key, args.name)));
    ...
    }, wrapToolHandler((args) => eventsApp.publishInteragentMessage(events, buildChannelName(args.channel), args.sender_agent_key, args.payload)));
    ...
    }, wrapToolHandler((args) => eventsApp.getChannelLog(events, buildChannelName(args.channel), args.limit)));
}
